...
impl Register {
    ...
    pub const fn size(&self) -> Size {
        ...
        unsafe { transmute(((self.0 & 0b1111_00_000) >> 5) as u8) }
    }
    pub const fn purpose(&self) -> Purpose {
        use std::mem::transmute;
        unsafe { transmute(((self.0 & 0b000_1111_0000_00_000) >> 9) as u8) }
    }
    pub const fn ebits(&self) -> [bool; 2] {
...
impl std::fmt::Debug for Register {
    fn fmt(&self, fmt: &mut std::fmt::Formatter<'_>) -> Result<(), std::fmt::Error> {
        write!(fmt, "Register({})", self.to_string())?;
        Ok(())
    }
}
...
impl ToString for Register {
    fn to_string(&self) -> String {
        match *self {
            ...
            Self::MM0 => String::from("mm0"),
            Self::MM1 => String::from("mm1"),
            Self::MM2 => String::from("mm2"),
            Self::MM3 => String::from("mm3"),
            Self::MM4 => String::from("mm4"),
            ...
            Self::K3 => String::from("k3"),
            Self::K4 => String::from("k4"),
            Self::K5 => String::from("k5"),
            Self::K6 => String::from("k6"),
            Self::K7 => String::from("k7"),
            ...
            Self::XMM16 => String::from("xmm16"),
            Self::XMM17 => String::from("xmm17"),
            Self::XMM18 => String::from("xmm18"),
            Self::XMM19 => String::from("xmm19"),
            Self::XMM20 => String::from("xmm20"),
            Self::XMM21 => String::from("xmm21"),
            Self::XMM22 => String::from("xmm22"),
            Self::XMM23 => String::from("xmm23"),
            Self::XMM24 => String::from("xmm24"),
            Self::XMM25 => String::from("xmm25"),
            Self::XMM26 => String::from("xmm26"),
            Self::XMM27 => String::from("xmm27"),
            Self::XMM28 => String::from("xmm28"),
            Self::XMM29 => String::from("xmm29"),
            Self::XMM30 => String::from("xmm30"),
            Self::XMM31 => String::from("xmm31"),
            ...
            Self::YMM16 => String::from("ymm16"),
            Self::YMM17 => String::from("ymm17"),
            Self::YMM18 => String::from("ymm18"),
            Self::YMM19 => String::from("ymm19"),
            Self::YMM20 => String::from("ymm20"),
            Self::YMM21 => String::from("ymm21"),
            Self::YMM22 => String::from("ymm22"),
            Self::YMM23 => String::from("ymm23"),
            Self::YMM24 => String::from("ymm24"),
            Self::YMM25 => String::from("ymm25"),
            Self::YMM26 => String::from("ymm26"),
            Self::YMM27 => String::from("ymm27"),
            Self::YMM28 => String::from("ymm28"),
            Self::YMM29 => String::from("ymm29"),
            Self::YMM30 => String::from("ymm30"),
            Self::YMM31 => String::from("ymm31"),
            ...
            Self::ZMM16 => String::from("zmm16"),
            Self::ZMM17 => String::from("zmm17"),
            Self::ZMM18 => String::from("zmm18"),
            Self::ZMM19 => String::from("zmm19"),
            Self::ZMM20 => String::from("zmm20"),
            Self::ZMM21 => String::from("zmm21"),
            Self::ZMM22 => String::from("zmm22"),
            Self::ZMM23 => String::from("zmm23"),
            Self::ZMM24 => String::from("zmm24"),
            Self::ZMM25 => String::from("zmm25"),
            Self::ZMM26 => String::from("zmm26"),
            Self::ZMM27 => String::from("zmm27"),
            Self::ZMM28 => String::from("zmm28"),
            Self::ZMM29 => String::from("zmm29"),
            Self::ZMM30 => String::from("zmm30"),
            Self::ZMM31 => String::from("zmm31"),
