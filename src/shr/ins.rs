...
pub enum Mnemonic {
    ...
    ACMPAXADD, ACMPBXADD, ACMPCXADD, ACMPEXADD, ACMPGXADD,
    ACMPLXADD, ACMPOXADD, ACMPPXADD, ACMPSXADD, ACMPZXADD,

    ACMPAEXADD, ACMPBEXADD, ACMPGEXADD, ACMPLEXADD, ACMPNAXADD,
    ACMPNBXADD, ACMPNCXADD, ACMPNEXADD, ACMPNGXADD, ACMPNLXADD,
    ACMPNOXADD, ACMPNPXADD, ACMPNSXADD, ACMPNZXADD, ACMPPEXADD, ACMPPOXADD,
    
    ACMPNBEXADD, ACMPNAEXADD, ACMPNGEXADD,ACMPNLEXADD,

    ACRC2, ADEC, ADIV, AENQCMD, AENQCMDS, AIDIV,
    AIMUL, AIMULZU, AINC, AINVEPT, AINVPCID, AINVVPID,
    AKMOVB, AKMOVD, AKMOVQ, AKMOVW, ALDTILECFG, ALZCNT,
    AMOVBE, AMOVDIR64B, AMOVDIRI, AMOVRS, AMUL, AMULX,
    ANEG, ANOT, AOR, APDEP, APEXT, APOPCNT,

    ARCL, ARCR, ARDMSR, AROL, AROR, ARORX, ASAR, ASAL, ASARX,
    ASBB, ASHL, ASHR, ASHRD, ASHRX, ASHLD, ASHLX, ASTTTILECFG,
    ASUB, ATZCNT, AURDMSR, AUWRMSR, AWRMSRNS, AWRSSD, AWRSSQ,
    AWRUSSD, AWRUSSQ, AXOR,

    JMPABS,

    // intel-apx1
    CCMPAE, CCMPBE, CCMPGE, CCMPLE, CCMPNA,
    CCMPNB, CCMPNC, CCMPNE, CCMPNG, CCMPNL,
    CCMPNO, CCMPNP, CCMPNS, CCMPNZ, CCMPPE, CCMPPO,
    CCMPNBE, CCMPNAE, CCMPNGE,CCMPNLE,

    // intel-apx2
    CFCMOVAE, CFCMOVBE, CFCMOVGE, CFCMOVLE, CFCMOVNA,
    CFCMOVNB, CFCMOVNC, CFCMOVNE, CFCMOVNG, CFCMOVNL,
    CFCMOVNO, CFCMOVNP, CFCMOVNS, CFCMOVNZ, CFCMOVPE, CFCMOVPO,
    CFCMOVNBE, CFCMOVNAE, CFCMOVNGE,CFCMOVNLE,
    
    // intel-apx3
    CTESTAE, CTESTBE, CTESTGE, CTESTLE, CTESTNA,
    CTESTNB, CTESTNC, CTESTNE, CTESTNG, CTESTNL,
    CTESTNO, CTESTNP, CTESTNS, CTESTNZ, CTESTPE, CTESTPO,
    CTESTNBE, CTESTNAE, CTESTNGE,CTESTNLE,
    
    // intel-apx4
    ASETAE, ASETBE, ASETGE, ASETLE, ASETNA,
    ASETNB, ASETNC, ASETNE, ASETNG, ASETNL,
    ASETNO, ASETNP, ASETNS, ASETNZ, ASETPE, ASETPO,
    ASETNBE, ASETNAE, ASETNGE,ASETNLE,
