...
pub enum Mnemonic {
    ...
    MOVZX, MULX, OUT, OUTS, OUTSB, OUTSD, OUTSW, PEXT,
    ...
    WBINVD, VBNOINVD, WRFSBASE, WRGSBASE, WRMSR,
    WRPKRU, WRSSD, WRSSQ,
    // /tests/*/norm-part6.asm
    WRUSSD, WRUSSQ, XABORT, XRELEASE, XACQUIRE, XADD,
    XBEGIN, XCHG, XEND, XGETBV, XLAT, XLATB, XRESLDTRK,
    XRSTOR, XRSTORS, XRSTORS64, XSAVE, XSAVE64, XSAVEC,
        ...
        7 => match rstr[0] {
            'p' => match rstr[1] {
                ...
                'm' => match rstr[2] {
                    ...
                    'u' => match rstr[3] {
                        'l' => match rstr[4] {
                            'u' => ins_ie(&rstr, 5, &cc::<7>("pmuludq"), Ins::PMULUDQ),
                            'h' => ins_ie(&rstr, 5, &cc::<7>("pmulhuw"), Ins::PMULHUW),
                            _ => n(),
                        },
                        _ => n(),
                    },
        ...
        8 => match rstr[0] {
            ...
            'v' => match rstr[1] {
                ...
                'p' => match rstr[2] {
                    'm' => match rstr[3] {
                        'a' => match rstr[4] {
                            'd' => ins_ie(&rstr, 5, &cc::<8>("vpmaddwd"), Ins::VPMADDWD),
                            _ => n(),
                        },
                        'u' => match rstr[4] {
                            'l' => match rstr[5] {
                                'h' => ins_ie(&rstr, 5, &cc::<8>("vpmulhuw"), Ins::VPMULHUW),
                                'u' => ins_ie(&rstr, 5, &cc::<8>("vpmuludq"), Ins::VPMULUDQ),
                                _ => n(),
                            },
                            _ => n(),
                        },
        ...
        9 => match rstr[0] {
            ...
            'v' => match rstr[1] {
                ...
                'p' => match rstr[2] {
                    ...
                    'm' => ins_ie(&rstr, 3, &cc::<9>("vpmulhrsw"), Ins::VPMULHRSW),
                    _ => n(),
                },
                'b' => match rstr[2] {
                    'l' => match rstr[3] {
