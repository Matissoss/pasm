...
pub enum Mnemonic {
    ...
    // missing support
    // part 0
    RDFSBASE, RDGSBASE, MOVDIRI64B, WBNOINVD,
    PREFETCHIT0, PREFETCHIT1, PTWRITE, PCONFIG, 
    SENDUIPD, ENQCMD, AENDQCMD, URDMSR, AURDMSR,
    AUWRMSR, UWRMSR, WRMSRNS, AWRMSRNS, ENQCMDS,

    // part 1
    AENQCMDS, AENQCMD, RDMSRLIST, WRMSRLIST,
    PBNDKB, BOUND, POPAB, POPAW, POPAD, POPAQ,
    PUSHAB, PUSHAW, PUSHAD, PUSHAQ, SGDT, SIDT,
    SLDT, LOADALL, STOREALL, MOVSX, LFS, LGS,
    
    // part 2
    UMOV, ICEBP, INT01, XBTS, IBTS, LOADALLD, LOADALL386,
    WBINDV, NOPL, UD2A, UD2B, OIO, SWAPGS, MOVSXD,

    // part 3
    XSTORE, XSTORE_RNG, XRNG2, XCRYPT_ECB, XCRYPT_CBC, XCRYPT_CFB,
    XCRYPT_OFB, XCRYPT_CTR, XSHA1, XSHA256, XSHA384, XSHA512,
    MONTMUL, MONTMUL2, XMODEXP,
    ...
    // part 2
    FADD, FMUL, FSUB, FSUBR, FDIV, FDIVR, FCOM, FADDP, FMULP, FSUBP, FSUBPR,
    FDIVP, FDIVPR, FCOMP, FCOMPP,
    ...
    // part 4
    FNOP, FDECSTP, FINCSTP, FFREE, FSTPNCE, FFREEP, FNSETPM,
    FUCOM, FUCOMP, FUCOMPP, FPREM1, FSINCOS, FSIN, FCOS,

    // part 5
    FCMOVB, FCMOVE, FCMOVBE, FCMOVU, FCMOVNB, FCMOVNE, FCMOVNBE, FCMOVNU,
    FCOMI, FCOMIP, FUCOMI, FUCOMIP, FXSAVE, FXRSTOR, FISTTP,
    ...
    // AMD Specific
    MONITORX, MWAITX, CLZERO, RDPRU, MCOMMIT, INVLPGB,
    
    // CMPccXADD
    CMPBXADD, CMPBEXADD, CMPFXADD, CMPLXADD, CMPLEXADD,
    CMPNBXADD, CMPZXADD, CMPNBEXADD, CMPNLXADD, CMPNLEXADD,
    CMPNOXADD, CMPNSXADD, CMPNZXADD, CMPOXADD, CMPSXADD, CMPTXADD,
        // pasm's added mnemonics
        CMPNAXADD, CMPAXADD, CMPNAEXADD, CMPAEXADD, CMPEXADD, CMPNEXADD,
        CMPGEXADD, CMPGXADD, CMPNGXADD, CMPNGEXADD, CMPCXADD, CMPNCXADD,
    // APX extension
    ACMPBXADD, ACMPBEXADD, ACMPFXADD, ACMPLXADD, ACMPLEXADD,
    ACMPNBXADD, ACMPZXADD, ACMPNBEXADD, ACMPNLXADD, ACMPNLEXADD,
    ACMPNOXADD, ACMPNSXADD, ACMPNZXADD, ACMPOXADD, ACMPSXADD, ACMPTXADD,
        // pasm's added mnemonics
