...
pub enum Mnemonic {
    ...
    VCVTPD2QQ, VCVTPD2UQQ, VCVTPH2DQ, VCVTPH2PD,
    ...
    VEXTRACTI64x4, VFCMADDCPH, VFMADDCPH, VFMADDCSH, VFCMULCPH,
    VFMULCPH, VFMULCSH, VFIXUPIMMPD, VFIXUPIMMPS, VFIXUPIMMSD,
    VFIXUPIMMSS,
    ...
    VFNMADDSUB132PH, VFNMADDSUB213PH, VFNMADDSUB231PH,
    ...
    VFNMSUBADD132PH, VFNMSUBADD213PH, VFNMSUBADD231PH,
    ...
    VPBROADCASTD, VPBROADCASTQ, VPBROADCASTMB2Q,
    ...
    VPERMI2W, VPERMI2D, VPERMI2Q, VPERMI2PS, VPERMPD,
    ...
    VPMOVSQW, VPMOVUSQW, VPMOVWB, VPMOVSWB, VPMOVUSWB, VPMULTISHIFTQB,

    // avx-exta
    VPOPCNTB, VPOPCNTW, VPOPCNTD, VPOPCNTQ,VPROLVD, VPROLVQ,
    VPROLD, VPROLQ, VPRORD, VPRORVD, VPRORQ, VPRORVQ, VPSHLD,
    VPSHLDV, VPSHRD, VPSHRDV, VPSHUFBITQMB, VPSLLVW, VPSLLVD, VPSLLVQ,
    VPSRAVW, VPSRAVD, VPSRAVQ, VPSRLVW, VPSRLVD, VPSRLVQ, VPTERNLOGD,
    VPTERNLOGQ, VPTESTMB, VPTESTMW, VPTESTMD, VPTESTMQ,VPTESTNMB,
    VPTESTNMW, VPTESTNMD, VPTESTNMQ, VRANGEPD, VRANGEPS,VRANGESD,
