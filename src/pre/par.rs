...
use crate::{
    pre::mer::{
        BodyNode as BodyNodeS, BodyNodeEnum as BodyNode, MergerResult, RootNode as RootNodeS,
        RootNodeEnum as RootNode,
    },
    shr::{
        ast::ASTn, label::Label as LabelN, location::Location, num::Number, section::SectionN,
...
pub fn par_attrs(label: &mut LabelN, attrs: String) -> Result<(), Error> {
...
pub fn par(mer: MergerResult) -> Result<ASTn, Vec<Error>> {
    use LabelN as Label;
    use SectionN as Section;
    let mut ast = ASTn::default();
