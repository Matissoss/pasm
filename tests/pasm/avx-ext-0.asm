...
_start:
	...
	valignd {k5}, zmm20, zmm21, {bcst}, dword [rax], 10
	
	valignq {k3}, xmm20, xmm21, xmm22, 10
	valignq {k6}, ymm20, ymm21, ymm22, 10
	valignq {k5}, zmm20, zmm21, {bcst}, qword [rax], 10
	...
	vblendmps {k5}, zmm20, zmm21, {bcst}, dword [rax]
	
	vblendmpd {k3}, xmm20, xmm21, xmm22
	vblendmpd {k6}, ymm20, ymm21, ymm22
	vblendmpd {k5}, zmm20, zmm21, {bcst}, qword [rax]
